...
public class Producer implements CSProcess {
    ...
    public Producer (int id,int maxBuffer,Statistics myStats,Statistics globalStats) {
        this.id = id;
    ...
    private void refreshStats(){
        if (data.isRejected()) {
            //System.out.println("P: " + id + " rejected");
            myStats.addRejected();
            globalStats.addRejected();
        } else {
            //System.out.println("P:" + id + " produced " + data.getValue());
    ...
    public String getStatistic(){
        return myStats.returnProducerStats();
    }
}